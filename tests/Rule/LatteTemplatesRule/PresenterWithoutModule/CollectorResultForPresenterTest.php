...
final class CollectorResultForPresenterTest extends CollectorResultTest
{
    ...
    public function testComponents(): void
    {
        $this->analyse([
            ...
            'TEMPLATE default.latte ComponentsPresenter::default ["startupParent","presenter","control","variableFromParentCalledViaParent"] ["form","noType","implicitType","parentForm","onlyParentDefaultForm","someControl"]',
            'TEMPLATE create.latte ComponentsPresenter::create ["startupParent","presenter","control"] ["form","noType","implicitType","parentForm","onlyCreateForm"]',
            'TEMPLATE parent.latte ComponentsPresenter::parent ["startupParent","presenter","control","variableFromParentAction"] ["form","noType","implicitType","parentForm","parentDefaultForm"]',
            'TEMPLATE noAction.latte ComponentsPresenter:: ["startupParent","presenter","control"] ["form","noType","implicitType","parentForm"]',
